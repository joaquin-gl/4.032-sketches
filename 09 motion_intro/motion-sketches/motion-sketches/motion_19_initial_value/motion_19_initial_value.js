// 19
// + this version avoids the points flying in from the upper-left corner
//   by starting with x and y set to 'null', and then inside setIndent()
//   and setAmount(), creating the SoftNum on first use.
